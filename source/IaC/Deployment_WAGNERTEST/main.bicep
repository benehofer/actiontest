...
param ad_groupoupath string = 'ou=Snowgroups,ou=groups,ou=datacenter,ou=chwid,dc=chwid,dc=local'

@secure()
@description('The username of the ADDS user (admin)')
param ad_username string = 'CHWID\\widup'
...
param ad_useroupath string = 'ou=snowusers,ou=onprem,ou=chwid,dc=chwid,dc=local'

@secure()
@description('The password of the ADDS user (admin)')
param ad_userpassword string = 'kHGU65H3@#%gTHHJGGH'
...
param api_base_url string = 'https://wid-func-widup-201.azurewebsites.net/'

@description('The name of the the application insights resource')
param application_insigths_name string = 'wid-appi-widup-201'

@description('The name of the app service plan for the Azure function')
param app_service_plan_name string = 'wid-plan-widup-201'
...
param crm_environment_url string = 'https://wagner-test.crm4.dynamics.com'

@description('The dataverse environment id')
param dv_environment_id string = '23fa6d4b-fb30-e2ae-873f-33b560a4f055'
...
param dv_environment_url string = 'https://org64c87f92.crm17.dynamics.com'
...
param function_app_name string = 'wid-func-widup-201'
...
param hybrid_connection_name string = 'wid-hycon-widup-201'

@description('The fqdn of the ad server name used in the hybrid connection')
param hycon_adserver_name string = 'scwidmgt99'
...
param keyvault_name string = 'wid-vault-widup-201'
...
param snow_table_url_debitor string = 'https://wagnerdev.service-now.com/api/now/v2/table/core_company'

@description('The snow api table url for the jobhead entity; this url is used to check for consistency')
param snow_table_url_jobhead string = 'https://wagnerdev.service-now.com/api/now/v2/table/ast_service'

@description('The snow api table url for the jobplanningline entity; this url is used to check for consistency')
param snow_table_url_jobplanningline string = 'https://wagnerdev.service-now.com/api/now/v2/table/u_cmdb_ci_project_plan_item'

@description('The snow api table url for the jobtask entity; this url is used to check for consistency')
param snow_table_url_jobtask string = 'https://wagnerdev.service-now.com/api/now/v2/table/u_article'

@description('The snow api table url for the timecard entity; this url is used to check for consistency')
param snow_table_url_journal string = 'https://wagnerdev.service-now.com/api/now/v2/table/time_card'

@description('The snow api table url for the outbound message entity; this url is used to check for consistency')
param snow_table_url_outbound_message string = 'https://wagnerdev.service-now.com/api/now/v2/table/u_if_outbound_message'
...
param storage_account_name string = 'widsawidup201'
...
param target_subscription_id string = '045e4288-7f9b-4c88-b100-9e837bb80e50'
